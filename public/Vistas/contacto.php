            ...
            <section id="navbar" class="w-100">
                <div class="nav-scroller py-1 mb-3 border-bottom rounded w-100">
                    <nav class="nav nav-underline justify-content-between align-items-center w-100">
                        ...
                        <a class="nav-item nav-link link-body-emphasis nav-links"
                            href="../../public/Vistas/negocios.php">Economía y Negocios</a>
                        <a class="nav-item nav-link link-body-emphasis nav-links" href="../../public/Vistas/mundo.php">Mundo</a>
                        <a class="nav-item nav-link link-body-emphasis nav-links active" href="../../public/Vistas/contacto.php">Contacto</a>
                    </nav>
                </div>
        </div>
    </section>
    ...
    <div class="container d-flex justify-content-center">
        <main>
            <div class="py-5 text-center">
                <img class="d-block mx-auto mb-4" src="../../assets/images/email.png" alt="" width="72" height="57">
                <h2>Contacto</h2>
                <p class="lead">Escríbanos a través de este formulario y uno de nuestros representantes le responderá a la brevedad.</p>
            </div>
            ...
            <div class="row">
                <div class="col-md-last order-md-last d-flex justify-content-center">
                    <div class="col-md-6 col-lg-6">
                        ...
                        <form class="needs-validation" action="../Controladores/contactoController.php" method="POST" novalidate="">
                            <div class="row g-3">
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <label for="apellido" class="form-label" name="apellido">Apellido</label>
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="email" class="form-control" id="email" placeholder="correo@ejemplo.cl" name="correo">
                                    <div class="invalid-feedback">
                                    ...
                                    <div class="col-12">
                                    <label for="comentario" class="form-label" name="comentario">Comentarios</label>
                                    <textarea class="form-control" id="comentario" placeholder="Su texto aquí." name="comentario"></textarea>
                                </div>
                            </div>

                            <hr class="my-4">

                            <button class="w-100 btn btn-secondary btn-lg mb-5" id="btn-form" type="submit">Enviar mensaje</button>
                        </form>
                    </div>
                </div>
        </main>
